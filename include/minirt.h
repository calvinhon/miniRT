...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/08 16:29:21 by honguyen          #+#    #+#             */
/*   Updated: 2025/02/08 16:29:21 by honguyen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_mat4d		rt_rotation_matrix_from_axis_angle(const \
	t_vec4d *axis, float angle);
...
t_vec4d		apply_bump_map(t_point *obj_p, t_frame *bump_map, \
	t_vec4d *orient_v);
