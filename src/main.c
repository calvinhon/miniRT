...
int main(int ac, char **av)
{
	...
	t_camera cam;
	cam = set_camera(PI / 3);
	cam.transform = view_transform(create_point(-25, 20, -5), create_point(0, 4, -12), create_vec4d(0, 1, 0));
	...
	// c1.transform = mult_n_mat4d(3, rotate_mat_x(0), scaling_mat(1, 1, 1), translation_mat(-8, 4, -16));
