...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/13 15:16:09 by chon              #+#    #+#             */
/*   Updated: 2025/01/13 15:16:09 by chon             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_color	color_at(t_scene *s, t_ray *r, int depth)
{
	...
	world_itxs = intersect_world(s, r);
...
t_color	render_pixel(t_minirt *program, int x, int y)
{
	...
	c = color_at(&program->scene, &r, _RT_REFLECTION_DEPTH);
	// printf("color: %f %f %f\n", c.r, c.g, c.b);
